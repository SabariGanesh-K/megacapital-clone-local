        ...
        <Page style={{backgroundColor:"#171819"}}>
            <MHidden width="mdDown">
              <Grid paddingLeft={'11%'} paddingRight={'11%'}>
                    ...
                    <Box component="h1" class="text-info">Help Center</Box>
                    </Grid>
                    ...
                    {helpList.map((item, key) => (
                      <Grid item md="4">
                        <Grid container direction="column" sx={{width:"100%"}}>
                          <Box width="100%">
                            <Box component="a" marginTop="10px" href={`/helpCenters/${item.slug}`} color="white" sx={{ textDecoration: 'none' }}> {key+1}. {item.htitle}  </Box>
                          </Box>
                        </Grid>
                      </Grid>
                    ))}
                ...
                <Grid container marginTop="70px" spacing={1}>
                    {items.map(item => (
                        <Grid item sm="12" lg="3" md="4" container>
                            <Box component="img" src={imageURL('Help_Center.png')} />
