...
export default function NewsDetaile(props){
        ...
        <Page style={{backgroundColor:"#171819"}}>
            <MHidden width="mdDown">
              <Grid paddingLeft={'11%'} paddingRight={'11%'}>
                    ...
                    <Box component="h1" class="text-info">{NewsInfo.title}</Box>
                  ...
                  <Grid container spacing={2}>
                      <Grid item md="12">
                        <Grid container direction="column" sx={{width:"100%"}}>
                          <Box width="100%">
                            <p style={{'padding-top':'10px'}}>{NewsInfo.sdescription}</p><br />
                            <img src={NewsInfo.image} width="70%" />
                            <p style={{'padding-top':'10px'}}>{NewsInfo.description}</p>
                          </Box>
                        </Grid>
                      </Grid>
                  </Grid>
